...
Map_Cut_t * Map_CutCompute( Map_Man_t * p, Map_CutTable_t * pTable, Map_Node_t * pNode )
{
    ...
    uint32 cutCount = 0;
    // printf("Computing cuts for node %d\n", pNode->Num);
...
//clk = Abc_Clock();
    ...
    // printf("Pre shuffle cuts list is: \n");

    // int j = 0;
    // for ( i = 0; pList; pList = pList->pNext, i++ )
    // {
    //     for(j=0; j < pList->nLeaves; j++){
    //         int pNodeChildIdx  = pList->ppLeaves[j]->Num;
    //         printf( "Child %d: %d\n", i, pNodeChildIdx );
    //     }
    // }
...
//pMan->time2 += Abc_Clock() - clk;
    ...
    // printf("Shuffled cuts list is: \n");
    // //p->pCuts1
    // j = 0;
    // for ( i = 0; i < nCuts; i++ )
    // {
    //     for(j=0; j < p->pCuts1[i]->nLeaves; j++){
    //         int pNodeChildIdx  = p->pCuts1[i]->ppLeaves[j]->Num;
    //         printf( "Child %d: %d\n", i, pNodeChildIdx );
    //     }
    // }
